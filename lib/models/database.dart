...
import 'package:lapkeu/models/category.dart';
import 'package:lapkeu/models/transaction.dart';
...
class AppDb extends _$AppDb {
  ...
  Future updateTransactionRepo(int id, int ammount, int categoryId, DateTime transactionDate, String nameDatail) async {
    return (update(transactions)..where((tbl) => tbl.id.equals(id)))
        .write(TransactionsCompanion(
            name: Value(nameDatail),
