               ...
               Row(children: [
                 ...
                 Column(
                   ...
                   children: [
                     ...
                     SizedBox(height: 10,),
                     Text("Rp. ******", style: GoogleFonts.montserrat(color: Colors.white, fontSize: 14))
                   ],
                 )
               ],),
               Row(children: [
                              ...
                              return Padding(
                                ...
                                child: Card(
                                  ...
                                  child: ListTile(
                                    ...
                                    leading: Container(
                                      child: (snapshot.data![index].category.type == 2) ? Icon(Icons.upload, color: Colors.red) : Icon(Icons.download, color: Colors.green),
                                      decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(8)),
                                    ),
                                  ),
                                ),
